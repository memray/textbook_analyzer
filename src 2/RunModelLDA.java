...
public class RunModelLDA {
	...
	public static void setUpParameters(){
		// Parameters for topic modeling
		iterations = 2000; // iteration of each run
		// TEXT PREPROCESSING
	...
	public static void main(String[] args){
		try{
			//simpleTestExperiment("Information_Retrieval");
			//testExperiment("Algebra");
			//testExperiment("Information_Retrieval");
			// JAVA
			/*
			experiment("Algebra", "TA", "10000", 150, 30);
			experiment("Algebra", "TA", "10111", 150, 30);
			...
			experiment("Algebra", "TA", "11000", 150, 30);
			experiment("Algebra", "TA", "01000", 150, 30);
			experiment("Algebra", "TA", "01111", 150, 30);
			*/
			...
			*/
			...
			//experiment("Information_Retrieval", "TA", "10111", 150, 30);
			//experiment("Information_Retrieval", "TA", "00010", 150, 30);
			//experiment("Information_Retrieval", "TA", "00110", 150, 30);
			//experiment("Information_Retrieval", "TA", "00111", 150, 30);
			//experiment("Information_Retrieval", "TA", "00001", 150, 30);
			
			//experiment("Information_Retrieval", "TA", "11111", 150, 30);
			//experiment("Information_Retrieval", "TA", "11000", 150, 30);
			//experiment("Information_Retrieval", "TA", "01000", 150, 30);
			//experiment("Information_Retrieval", "TA", "01111", 150, 30);
	...
	public static void buildLDAModel(String content, int ntopics, boolean[] usingbooks) throws Exception{
	...
	public static void runModelIterations(int runs, int ntopics, String cond_agg, String cond_books, boolean[] usingbooks, String output_folder) throws Exception{
		...
		for(int i=0;i<runs;i++){
			System.out.println("LDA RUN: "+(i+1)+"/"+runs);
			prefix = ""+(i+1);
			if (i<9) prefix = "0"+prefix;
			buildLDAModel(content_4_lda, ntopics, usingbooks);
			...
			if (i==0) ModelReporter.writeVocabularyList(col, output_folder+"/alphabet.txt");
		}
